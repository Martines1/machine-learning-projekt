...
#find ak chcem pomocou grid search najst parametre
#selected_method = models.find_SVC_model(X_train_vec, y_train)
#alebo select ak ich uz mam vybrate
selected_method, tag = models.get_NB_model(X_train_vec, y_train, alpha=0.3)


# Presnost na training
...
display = ConfusionMatrixDisplay(confusion_mat, display_labels=['Action', 'Comedy', 'Horror'])
